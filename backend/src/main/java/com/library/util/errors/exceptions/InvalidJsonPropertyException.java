...
@Getter
public class InvalidJsonPropertyException extends ApplicationRuntimeException {
     ...
     */
    public InvalidJsonPropertyException(String message, Integer httpStatus) {
     ...
     */
    public InvalidJsonPropertyException(String message, Integer httpStatus, Throwable cause) {
        super(message, httpStatus);
        this.cause = cause;
    }
}
