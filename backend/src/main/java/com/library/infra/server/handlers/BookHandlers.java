...
import com.library.application.controllers.books.PatchBookController;
...
public class BookHandlers {
    ...
    public static ServletContextHandler setupBookHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new PatchBookController()), "/update/book/*");
